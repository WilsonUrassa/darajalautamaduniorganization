...
const programmes = [
  { number: '01', title: 'Culture & Heritage', text: 'Protecting and celebrating Tanzania’s cultural identity, knowledge and community traditions.' },
  { number: '02', title: 'Community Development', text: 'Supporting locally led ideas that strengthen communities and create lasting opportunity.' },
  { number: '03', title: 'Youth Empowerment', text: 'Creating pathways for young people to learn, participate, lead and build their futures.' },
  { number: '04', title: 'Education & Skills', text: 'Promoting access to learning, practical skills and opportunities for personal growth.' },
  { number: '05', title: 'Livelihoods', text: 'Encouraging sustainable enterprise, economic participation and household resilience.' },
  { number: '06', title: 'Environment', text: 'Working with communities to protect natural resources and encourage sustainable practices.' },
